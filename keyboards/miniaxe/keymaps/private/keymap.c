...
/* todo ; を KC_L1_HOLD と同居させる*/
[_QWERTY] = LAYOUT_split_3x5_3(
      KC_Q,         KC_W, KC_E,  KC_R,            KC_T,             KC_Y,            KC_U,            KC_I,    KC_O,    KC_P,
      LSFT_T(KC_A), KC_S, KC_D,  KC_F,            KC_G,             KC_H,            KC_J,            KC_K,    KC_L,    KC_SCLN,
      LT(1,KC_Z),   KC_X, KC_C,  KC_V,            KC_B,             KC_N,            KC_M,            KC_COMM, KC_DOT,  KC_L1_HOLD,
                          KC_NO, LGUI_T(KC_LNG2), LCTL_T(KC_SPC),   LT(2,KC_ENT),    KC_L1_HOLD,      KC_SLSH
),
